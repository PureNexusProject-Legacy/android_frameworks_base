...
public class PowerNotificationWarnings implements PowerUI.WarningsUI {
    ...
    private void updateNotification() {
        ...
        } else if (mWarning && (Settings.System.getInt(mContext.getContentResolver(), Settings.System.BATTERY_LOW_NOTIFICATION, 1) == 1)) {
            showWarningNotification();
            mShowing = SHOWING_WARNING;
        } else if (mSaver && (Settings.System.getInt(mContext.getContentResolver(), Settings.System.BATTERY_SAVER_NOTIFICATION, 1) == 1)) {
